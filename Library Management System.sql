...
;
	...
	SELECT count FROM tbl_borrower groupby(borrower_BorrowerName)

	-- Group by command
	--To take count of each book borrowed customers count

	SELECT borrower_BorrowerName, COUNT(*) FROM tbl_borrower GROUP BY borrower_BorrowerName;
